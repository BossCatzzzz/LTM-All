...
public class fDangNhap extends javax.swing.JFrame {
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(32, 32, 32)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(tbusername, javax.swing.GroupLayout.DEFAULT_SIZE, 160, Short.MAX_VALUE)
    ...
    private void btLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btLoginActionPerformed
        String query = "select * from taikhoan where username='" + tbusername.getText().trim() + "' and password='" + tbpassword.getText().trim() + "'";
        try {
            DBAccess db = new DBAccess();
            ResultSet rs = db.Query(query);
            if (rs.next()) {
                JOptionPane.showMessageDialog(null, "Dang nhap thanh cong!", "Dang nhap thanh cong", JOptionPane.INFORMATION_MESSAGE);
                this.dispose();
            } else {
                JOptionPane.showMessageDialog(null, "Dang nhap that bai!", "Dang nhap that bai", JOptionPane.INFORMATION_MESSAGE);
            }
        } catch (SQLException ex) {
            JOptionPane.showMessageDialog(null, "Loi khi dang nhap!", "Loi khi dang nhap", 0);
        }
